...
const lstmData = [
  { stock: "Walmart", days: 18, percentage: "60.0%" },
  { stock: "Exxon", days: 21, percentage: "70.0%" },
  { stock: "Apple", days: 17, percentage: "56.7%" },
  { stock: "JP Morgan", days: 16, percentage: "53.3%" },
  { stock: "Pfizer", days: 19, percentage: "63.3%" }
];
...
export default function LSTMPage() {
  return (
    <div className={`${geistSans.variable} ${geistMono.variable} relative flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100 overflow-hidden pt-20`}>
      {/* Background Images */}
      <div className="absolute top-1/4 left-0 -z-10 hidden md:block opacity-20 dark:opacity-30 pointer-events-none">
        <Image src="/bear.png" alt="Bear outline" width={400} height={400} className="max-w-md lg:max-w-lg" />
      </div>
      <div className="absolute top-1/4 right-0 -z-10 hidden md:block opacity-20 dark:opacity-30 pointer-events-none">
        <Image src="/bull.png" alt="Bull outline" width={400} height={400} className="max-w-md lg:max-w-lg" />
      </div>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-gray-700">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Correct Days</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Accuracy</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {lstmData.map((item, index) => (
